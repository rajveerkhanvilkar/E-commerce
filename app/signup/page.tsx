...
import { ArrowLeft, Mail, Lock, User, CheckCircle, Loader2, AlertCircle } from 'lucide-react';
...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6 relative overflow-hidden font-sans text-white">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-purple-900/40 via-zinc-950 to-zinc-950 z-0"></div>
            <motion.div
                animate={{ scale: [1, 1.2, 1], rotate: [0, -90, 0] }}
                transition={{ duration: 25, repeat: Infinity }}
                className="absolute top-20 left-20 w-[600px] h-[600px] bg-rose-500/10 rounded-full blur-[120px]"
            ></motion.div>
            <motion.div
                animate={{ scale: [1, 1.5, 1], rotate: [0, 90, 0] }}
                transition={{ duration: 20, repeat: Infinity }}
                className="absolute bottom-20 right-20 w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-[100px]"
            ></motion.div>
                    ...
                    <motion.div style={{ translateZ: 20 }}>
                        ...
                        {success ? (
                            ...
                            >
                                ...
                                <p className="text-zinc-400">Welcome aboard.</p>
                            </motion.div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group/input">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within/input:text-rose-500 transition-colors" size={20} />
                                        <input
                                            type="text"
                                            required
                                            value={name}
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    disabled={loading}
                                    className="w-full bg-gradient-to-r from-rose-500 to-purple-600 text-white font-bold py-4 rounded-xl hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all flex items-center justify-center gap-2"
                                >
                                    {loading ? (
